	...
	jsPROD: function() {
		 ...
		 */
		 ...
		 function slidersInit() {
		 	...
		 	$('#x-related-products-carousel').not('.slick-initialized').slick(sliderSettings);
		 }
		 

		 //Set height for image container to reduce jumpiness of images on change
		function imgSetHeight(img_container) {
		 	let img_height = img_container.offsetHeight + 'px';
 	 			img_container.style.height = img_height;
		 }
